...
from rl.multi_agent_envs import MultiAgentOrderEnv
...
if __name__ == "__main__":
    ...
    agent_list = ['spread_ppo_' + str(trader_id)]
    trader_id += 1
    agent_list = ['spread_dqn_' + str(trader_id)]

    # Simple environment with 4 independent cartpole entities
    register_env("multi_cartpole", lambda _: MultiAgentOrderEnv(agent_list, random_agent_list, episode_seconds=10))
